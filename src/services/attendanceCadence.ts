...
const EFFECTS: Record<ProgressActionId, CadenceEffect> = {
  ...
  channel_unavailable: {
    ...
    clearFollowup: true,
    taskType: null,
    instruction: "Canal indisponível — excluído da sua fila",
    templateId: null,
    toast: "Excluído · canal indisponível",
  },
  not_matching: {
    phase: "closed",
    leadStatus: "lost",
    ...
    clearFollowup: true,
    taskType: null,
    instruction: "Não correspondente — excluído da sua fila",
    templateId: null,
    toast: "Excluído · não correspondente",
  },
  lost: {
    phase: "closed",
    leadStatus: "lost",
  ...
  dismiss: {
    ...
    clearFollowup: true,
    taskType: null,
    instruction: "Oculto da sua fila",
    templateId: null,
