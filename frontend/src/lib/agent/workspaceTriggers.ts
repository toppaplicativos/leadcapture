...
const TRIGGERS: Record<string, WorkspaceTrigger> = {
  ...
  contabilidade: {
    skill: 'nav.contabilidade',
    userLabel: 'Financeiro',
    assistantMessage: 'Abrindo financeiro e contabilidade...',
    canvasPath: '/contabilidade',
  },
  administrativo: {
    skill: 'nav.administrativo',
    userLabel: 'Acessos Admin',
    assistantMessage: 'Abrindo acessos e permissões administrativas...',
    canvasPath: '/administrativo',
  },
  'app-administrativo': {
    skill: 'nav.app-administrativo',
    userLabel: 'App Administrativo',
    assistantMessage: 'Abrindo o ambiente administrativo...',
    canvasPath: '/app-administrativo/painel',
  },
  criativos: {
  ...
  clube: {
    skill: 'nav.clube',
    userLabel: 'Clube Assinantes',
    assistantMessage: 'Abrindo clube de assinantes…',
    canvasPath: '/clube',
  },
  frete: {
    skill: 'nav.frete',
...
export const CANVAS_NAV_SKILLS: Record<string, string> = {
  ...
  'nav.estoque': '/estoque',
  'nav.contabilidade': '/contabilidade',
  'nav.administrativo': '/administrativo',
  'nav.app-administrativo': '/app-administrativo/painel',
...
export const OBJECTIVE_GROUPS: ObjectiveGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { skill: 'nav.clube', userLabel: 'Clube Assinantes', assistantMessage: 'Abrindo clube de assinantes…', canvasPath: '/clube' },
