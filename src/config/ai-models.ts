...
export const AI_MODELS: Record<AICategory, Record<string, AIModelDef[]>> = {
  ...
  video: {
    atlas: [
      ...
      { id: "bytedance/seedance-2.0", label: "Atlas · Seedance 2.0", tier: "expensive", cost_label: "~$0.12/s", usd_per_second: 0.12, functions: ["t2v", "i2v", "v2v"] },
      ...
      { id: "alibaba/wan-2.7", label: "Atlas · Wan 2.7", tier: "medium", cost_label: "~$0.08/s", usd_per_second: 0.08, functions: ["t2v", "i2v", "v2v"] },
      { id: "vidu/vidu-q2", label: "Atlas · Vidu Q2", tier: "medium", cost_label: "~$0.07/s", usd_per_second: 0.07, functions: ["t2v", "i2v", "v2v"] },
