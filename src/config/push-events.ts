...
export const PUSH_EVENT_SEED: PushEventDefinition[] = [
  ...
  ev("affiliate", "sales", "challenge_available", "Nova premiação / desafio", { default_priority: "high", sound_key: "sale", sort_order: 37 }),
  ev("affiliate", "sales", "challenge_won", "Você venceu uma premiação", { default_priority: "high", sound_key: "sale", sort_order: 38 }),
  ev("affiliate", "sales", "rank_updated", "Sua posição no ranking mudou", { default_priority: "normal", default_enabled: false, sort_order: 39 }),
