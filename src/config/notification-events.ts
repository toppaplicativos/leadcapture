...
export const NOTIFICATION_EVENT_REGISTRY: NotificationEventDefinition[] = [
  ...
  def("affiliate", "sales", "affiliate.challenge.available", "commercial_event",
    "Nova premiação na rede",
    "{{challenge_title}} — {{prize_label}}. Entre na disputa e suba no ranking!",
    {
      default_priority: "high",
      cta_label: "Ver premiação",
      deep_link_template: "/ranking",
      sound_key: "sale",
      action_required: true,
    }),
  def("affiliate", "sales", "affiliate.challenge.won", "commercial_event",
    "Você venceu!",
    "Parabéns! Você venceu: {{challenge_title}}. Prêmio: {{prize_label}}.",
    {
      default_priority: "high",
      cta_label: "Ver premiação",
      deep_link_template: "/ranking",
  ...
  def("affiliate", "sales", "affiliate.ranking.updated", "informational",
    "Ranking atualizado",
    "Sua posição agora é #{{rank}} de {{of}} na rede.",
    {
      default_priority: "normal",
      cta_label: "Ver ranking",
      deep_link_template: "/ranking",
      can_be_disabled_by_user: true,
    }),
...
export const EVENT_KEY_ALIASES: Record<string, string> = {
  ...
  challenge_available: "affiliate.challenge.available",
  challenge_won: "affiliate.challenge.won",
  rank_updated: "affiliate.ranking.updated",
